...
// checks if the ResponseProjectsCreate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseProjectsCreate{}

// ResponseProjectsCreate struct for ResponseProjectsCreate
type ResponseProjectsCreate struct {
...
type _ResponseProjectsCreate ResponseProjectsCreate
...
func (o ResponseProjectsCreate) MarshalJSON() ([]byte, error) {
...
func (o ResponseProjectsCreate) ToMap() (map[string]interface{}, error) {
...
func (o *ResponseProjectsCreate) UnmarshalJSON(data []byte) (err error) {
	...
	varResponseProjectsCreate := _ResponseProjectsCreate{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResponseProjectsCreate)

	if err != nil {
		return err
	}

	*o = ResponseProjectsCreate(varResponseProjectsCreate)

	return err
}

type NullableResponseProjectsCreate struct {
	value *ResponseProjectsCreate
	isSet bool
}

func (v NullableResponseProjectsCreate) Get() *ResponseProjectsCreate {
	return v.value
}

func (v *NullableResponseProjectsCreate) Set(val *ResponseProjectsCreate) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseProjectsCreate) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseProjectsCreate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseProjectsCreate(val *ResponseProjectsCreate) *NullableResponseProjectsCreate {
	return &NullableResponseProjectsCreate{value: val, isSet: true}
}

func (v NullableResponseProjectsCreate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseProjectsCreate) UnmarshalJSON(src []byte) error {
	v.isSet = true

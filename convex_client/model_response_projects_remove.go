...
// checks if the ResponseProjectsRemove type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseProjectsRemove{}

// ResponseProjectsRemove struct for ResponseProjectsRemove
type ResponseProjectsRemove struct {
...
type _ResponseProjectsRemove ResponseProjectsRemove
...
func (o ResponseProjectsRemove) MarshalJSON() ([]byte, error) {
...
func (o ResponseProjectsRemove) ToMap() (map[string]interface{}, error) {
...
func (o *ResponseProjectsRemove) UnmarshalJSON(data []byte) (err error) {
	...
	varResponseProjectsRemove := _ResponseProjectsRemove{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResponseProjectsRemove)

	if err != nil {
		return err
	}

	*o = ResponseProjectsRemove(varResponseProjectsRemove)

	return err
}

type NullableResponseProjectsRemove struct {
	value *ResponseProjectsRemove
	isSet bool
}

func (v NullableResponseProjectsRemove) Get() *ResponseProjectsRemove {
	return v.value
}

func (v *NullableResponseProjectsRemove) Set(val *ResponseProjectsRemove) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseProjectsRemove) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseProjectsRemove) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseProjectsRemove(val *ResponseProjectsRemove) *NullableResponseProjectsRemove {
	return &NullableResponseProjectsRemove{value: val, isSet: true}
}

func (v NullableResponseProjectsRemove) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseProjectsRemove) UnmarshalJSON(src []byte) error {
	v.isSet = true

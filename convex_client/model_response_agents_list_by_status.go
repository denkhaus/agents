...
// checks if the ResponseAgentsListByStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseAgentsListByStatus{}

// ResponseAgentsListByStatus struct for ResponseAgentsListByStatus
type ResponseAgentsListByStatus struct {
...
type _ResponseAgentsListByStatus ResponseAgentsListByStatus
...
func NewResponseAgentsListByStatus(status string) *ResponseAgentsListByStatus {
	this := ResponseAgentsListByStatus{}
	this.Status = status
	return &this
}
...
func (o ResponseAgentsListByStatus) MarshalJSON() ([]byte, error) {
...
func (o ResponseAgentsListByStatus) ToMap() (map[string]interface{}, error) {
...
func (o *ResponseAgentsListByStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varResponseAgentsListByStatus := _ResponseAgentsListByStatus{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResponseAgentsListByStatus)

	if err != nil {
		return err
	}

	*o = ResponseAgentsListByStatus(varResponseAgentsListByStatus)

	return err
}

type NullableResponseAgentsListByStatus struct {
	value *ResponseAgentsListByStatus
	isSet bool
}

func (v NullableResponseAgentsListByStatus) Get() *ResponseAgentsListByStatus {
	return v.value
}

func (v *NullableResponseAgentsListByStatus) Set(val *ResponseAgentsListByStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseAgentsListByStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseAgentsListByStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseAgentsListByStatus(val *ResponseAgentsListByStatus) *NullableResponseAgentsListByStatus {
	return &NullableResponseAgentsListByStatus{value: val, isSet: true}
}

func (v NullableResponseAgentsListByStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseAgentsListByStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true

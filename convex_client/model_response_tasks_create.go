...
// checks if the ResponseTasksCreate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseTasksCreate{}

// ResponseTasksCreate struct for ResponseTasksCreate
type ResponseTasksCreate struct {
...
type _ResponseTasksCreate ResponseTasksCreate
...
func (o ResponseTasksCreate) MarshalJSON() ([]byte, error) {
...
func (o ResponseTasksCreate) ToMap() (map[string]interface{}, error) {
...
func (o *ResponseTasksCreate) UnmarshalJSON(data []byte) (err error) {
	...
	varResponseTasksCreate := _ResponseTasksCreate{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResponseTasksCreate)

	if err != nil {
		return err
	}

	*o = ResponseTasksCreate(varResponseTasksCreate)

	return err
}

type NullableResponseTasksCreate struct {
	value *ResponseTasksCreate
	isSet bool
}

func (v NullableResponseTasksCreate) Get() *ResponseTasksCreate {
	return v.value
}

func (v *NullableResponseTasksCreate) Set(val *ResponseTasksCreate) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseTasksCreate) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseTasksCreate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseTasksCreate(val *ResponseTasksCreate) *NullableResponseTasksCreate {
	return &NullableResponseTasksCreate{value: val, isSet: true}
}

func (v NullableResponseTasksCreate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseTasksCreate) UnmarshalJSON(src []byte) error {
	v.isSet = true

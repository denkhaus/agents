...
// checks if the ResponseSettingsGetSettings type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseSettingsGetSettings{}

// ResponseSettingsGetSettings struct for ResponseSettingsGetSettings
type ResponseSettingsGetSettings struct {
...
type _ResponseSettingsGetSettings ResponseSettingsGetSettings
...
func NewResponseSettingsGetSettings(status string) *ResponseSettingsGetSettings {
	this := ResponseSettingsGetSettings{}
	this.Status = status
	return &this
}
...
func (o ResponseSettingsGetSettings) MarshalJSON() ([]byte, error) {
...
func (o ResponseSettingsGetSettings) ToMap() (map[string]interface{}, error) {
...
func (o *ResponseSettingsGetSettings) UnmarshalJSON(data []byte) (err error) {
	...
	varResponseSettingsGetSettings := _ResponseSettingsGetSettings{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResponseSettingsGetSettings)

	if err != nil {
		return err
	}

	*o = ResponseSettingsGetSettings(varResponseSettingsGetSettings)

	return err
}

type NullableResponseSettingsGetSettings struct {
	value *ResponseSettingsGetSettings
	isSet bool
}

func (v NullableResponseSettingsGetSettings) Get() *ResponseSettingsGetSettings {
	return v.value
}

func (v *NullableResponseSettingsGetSettings) Set(val *ResponseSettingsGetSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseSettingsGetSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseSettingsGetSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseSettingsGetSettings(val *ResponseSettingsGetSettings) *NullableResponseSettingsGetSettings {
	return &NullableResponseSettingsGetSettings{value: val, isSet: true}
}

func (v NullableResponseSettingsGetSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseSettingsGetSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true

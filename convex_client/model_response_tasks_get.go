...
// checks if the ResponseTasksGet type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseTasksGet{}

// ResponseTasksGet struct for ResponseTasksGet
type ResponseTasksGet struct {
...
type _ResponseTasksGet ResponseTasksGet
...
func (o ResponseTasksGet) MarshalJSON() ([]byte, error) {
...
func (o ResponseTasksGet) ToMap() (map[string]interface{}, error) {
...
func (o *ResponseTasksGet) UnmarshalJSON(data []byte) (err error) {
	...
	varResponseTasksGet := _ResponseTasksGet{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResponseTasksGet)

	if err != nil {
		return err
	}

	*o = ResponseTasksGet(varResponseTasksGet)

	return err
}

type NullableResponseTasksGet struct {
	value *ResponseTasksGet
	isSet bool
}

func (v NullableResponseTasksGet) Get() *ResponseTasksGet {
	return v.value
}

func (v *NullableResponseTasksGet) Set(val *ResponseTasksGet) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseTasksGet) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseTasksGet) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseTasksGet(val *ResponseTasksGet) *NullableResponseTasksGet {
	return &NullableResponseTasksGet{value: val, isSet: true}
}

func (v NullableResponseTasksGet) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseTasksGet) UnmarshalJSON(src []byte) error {
	v.isSet = true

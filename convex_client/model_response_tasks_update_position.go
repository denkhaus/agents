...
// checks if the ResponseTasksUpdatePosition type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseTasksUpdatePosition{}

// ResponseTasksUpdatePosition struct for ResponseTasksUpdatePosition
type ResponseTasksUpdatePosition struct {
...
type _ResponseTasksUpdatePosition ResponseTasksUpdatePosition
...
func NewResponseTasksUpdatePosition(status string) *ResponseTasksUpdatePosition {
	this := ResponseTasksUpdatePosition{}
	this.Status = status
	return &this
}
...
func (o ResponseTasksUpdatePosition) MarshalJSON() ([]byte, error) {
...
func (o ResponseTasksUpdatePosition) ToMap() (map[string]interface{}, error) {
...
func (o *ResponseTasksUpdatePosition) UnmarshalJSON(data []byte) (err error) {
	...
	varResponseTasksUpdatePosition := _ResponseTasksUpdatePosition{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResponseTasksUpdatePosition)

	if err != nil {
		return err
	}

	*o = ResponseTasksUpdatePosition(varResponseTasksUpdatePosition)

	return err
}

type NullableResponseTasksUpdatePosition struct {
	value *ResponseTasksUpdatePosition
	isSet bool
}

func (v NullableResponseTasksUpdatePosition) Get() *ResponseTasksUpdatePosition {
	return v.value
}

func (v *NullableResponseTasksUpdatePosition) Set(val *ResponseTasksUpdatePosition) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseTasksUpdatePosition) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseTasksUpdatePosition) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseTasksUpdatePosition(val *ResponseTasksUpdatePosition) *NullableResponseTasksUpdatePosition {
	return &NullableResponseTasksUpdatePosition{value: val, isSet: true}
}

func (v NullableResponseTasksUpdatePosition) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseTasksUpdatePosition) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// checks if the ResponseTasksListByAgent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseTasksListByAgent{}

// ResponseTasksListByAgent struct for ResponseTasksListByAgent
type ResponseTasksListByAgent struct {
...
type _ResponseTasksListByAgent ResponseTasksListByAgent
...
func (o ResponseTasksListByAgent) MarshalJSON() ([]byte, error) {
...
func (o ResponseTasksListByAgent) ToMap() (map[string]interface{}, error) {
...
func (o *ResponseTasksListByAgent) UnmarshalJSON(data []byte) (err error) {
	...
	varResponseTasksListByAgent := _ResponseTasksListByAgent{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResponseTasksListByAgent)

	if err != nil {
		return err
	}

	*o = ResponseTasksListByAgent(varResponseTasksListByAgent)

	return err
}

type NullableResponseTasksListByAgent struct {
	value *ResponseTasksListByAgent
	isSet bool
}

func (v NullableResponseTasksListByAgent) Get() *ResponseTasksListByAgent {
	return v.value
}

func (v *NullableResponseTasksListByAgent) Set(val *ResponseTasksListByAgent) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseTasksListByAgent) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseTasksListByAgent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseTasksListByAgent(val *ResponseTasksListByAgent) *NullableResponseTasksListByAgent {
	return &NullableResponseTasksListByAgent{value: val, isSet: true}
}

func (v NullableResponseTasksListByAgent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseTasksListByAgent) UnmarshalJSON(src []byte) error {
	v.isSet = true

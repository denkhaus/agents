...
// checks if the ResponseEventsSubscribeToProject type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseEventsSubscribeToProject{}

// ResponseEventsSubscribeToProject struct for ResponseEventsSubscribeToProject
type ResponseEventsSubscribeToProject struct {
...
type _ResponseEventsSubscribeToProject ResponseEventsSubscribeToProject
...
func NewResponseEventsSubscribeToProject(status string) *ResponseEventsSubscribeToProject {
	this := ResponseEventsSubscribeToProject{}
	this.Status = status
	return &this
}
...
func (o ResponseEventsSubscribeToProject) MarshalJSON() ([]byte, error) {
...
func (o ResponseEventsSubscribeToProject) ToMap() (map[string]interface{}, error) {
...
func (o *ResponseEventsSubscribeToProject) UnmarshalJSON(data []byte) (err error) {
	...
	varResponseEventsSubscribeToProject := _ResponseEventsSubscribeToProject{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResponseEventsSubscribeToProject)

	if err != nil {
		return err
	}

	*o = ResponseEventsSubscribeToProject(varResponseEventsSubscribeToProject)

	return err
}

type NullableResponseEventsSubscribeToProject struct {
	value *ResponseEventsSubscribeToProject
	isSet bool
}

func (v NullableResponseEventsSubscribeToProject) Get() *ResponseEventsSubscribeToProject {
	return v.value
}

func (v *NullableResponseEventsSubscribeToProject) Set(val *ResponseEventsSubscribeToProject) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseEventsSubscribeToProject) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseEventsSubscribeToProject) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseEventsSubscribeToProject(val *ResponseEventsSubscribeToProject) *NullableResponseEventsSubscribeToProject {
	return &NullableResponseEventsSubscribeToProject{value: val, isSet: true}
}

func (v NullableResponseEventsSubscribeToProject) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseEventsSubscribeToProject) UnmarshalJSON(src []byte) error {
	v.isSet = true

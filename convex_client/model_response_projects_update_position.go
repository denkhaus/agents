...
// checks if the ResponseProjectsUpdatePosition type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseProjectsUpdatePosition{}

// ResponseProjectsUpdatePosition struct for ResponseProjectsUpdatePosition
type ResponseProjectsUpdatePosition struct {
...
type _ResponseProjectsUpdatePosition ResponseProjectsUpdatePosition
...
func NewResponseProjectsUpdatePosition(status string) *ResponseProjectsUpdatePosition {
	this := ResponseProjectsUpdatePosition{}
	this.Status = status
	return &this
}
...
func (o ResponseProjectsUpdatePosition) MarshalJSON() ([]byte, error) {
...
func (o ResponseProjectsUpdatePosition) ToMap() (map[string]interface{}, error) {
...
func (o *ResponseProjectsUpdatePosition) UnmarshalJSON(data []byte) (err error) {
	...
	varResponseProjectsUpdatePosition := _ResponseProjectsUpdatePosition{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResponseProjectsUpdatePosition)

	if err != nil {
		return err
	}

	*o = ResponseProjectsUpdatePosition(varResponseProjectsUpdatePosition)

	return err
}

type NullableResponseProjectsUpdatePosition struct {
	value *ResponseProjectsUpdatePosition
	isSet bool
}

func (v NullableResponseProjectsUpdatePosition) Get() *ResponseProjectsUpdatePosition {
	return v.value
}

func (v *NullableResponseProjectsUpdatePosition) Set(val *ResponseProjectsUpdatePosition) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseProjectsUpdatePosition) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseProjectsUpdatePosition) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseProjectsUpdatePosition(val *ResponseProjectsUpdatePosition) *NullableResponseProjectsUpdatePosition {
	return &NullableResponseProjectsUpdatePosition{value: val, isSet: true}
}

func (v NullableResponseProjectsUpdatePosition) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseProjectsUpdatePosition) UnmarshalJSON(src []byte) error {
	v.isSet = true

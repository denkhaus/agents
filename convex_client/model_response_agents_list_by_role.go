...
// checks if the ResponseAgentsListByRole type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseAgentsListByRole{}

// ResponseAgentsListByRole struct for ResponseAgentsListByRole
type ResponseAgentsListByRole struct {
...
type _ResponseAgentsListByRole ResponseAgentsListByRole
...
func (o ResponseAgentsListByRole) MarshalJSON() ([]byte, error) {
...
func (o ResponseAgentsListByRole) ToMap() (map[string]interface{}, error) {
...
func (o *ResponseAgentsListByRole) UnmarshalJSON(data []byte) (err error) {
	...
	varResponseAgentsListByRole := _ResponseAgentsListByRole{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResponseAgentsListByRole)

	if err != nil {
		return err
	}

	*o = ResponseAgentsListByRole(varResponseAgentsListByRole)

	return err
}

type NullableResponseAgentsListByRole struct {
	value *ResponseAgentsListByRole
	isSet bool
}

func (v NullableResponseAgentsListByRole) Get() *ResponseAgentsListByRole {
	return v.value
}

func (v *NullableResponseAgentsListByRole) Set(val *ResponseAgentsListByRole) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseAgentsListByRole) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseAgentsListByRole) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseAgentsListByRole(val *ResponseAgentsListByRole) *NullableResponseAgentsListByRole {
	return &NullableResponseAgentsListByRole{value: val, isSet: true}
}

func (v NullableResponseAgentsListByRole) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseAgentsListByRole) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// checks if the ResponseAgentsList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseAgentsList{}

// ResponseAgentsList struct for ResponseAgentsList
type ResponseAgentsList struct {
...
type _ResponseAgentsList ResponseAgentsList
...
func (o ResponseAgentsList) MarshalJSON() ([]byte, error) {
...
func (o ResponseAgentsList) ToMap() (map[string]interface{}, error) {
...
func (o *ResponseAgentsList) UnmarshalJSON(data []byte) (err error) {
	...
	varResponseAgentsList := _ResponseAgentsList{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResponseAgentsList)

	if err != nil {
		return err
	}

	*o = ResponseAgentsList(varResponseAgentsList)

	return err
}

type NullableResponseAgentsList struct {
	value *ResponseAgentsList
	isSet bool
}

func (v NullableResponseAgentsList) Get() *ResponseAgentsList {
	return v.value
}

func (v *NullableResponseAgentsList) Set(val *ResponseAgentsList) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseAgentsList) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseAgentsList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseAgentsList(val *ResponseAgentsList) *NullableResponseAgentsList {
	return &NullableResponseAgentsList{value: val, isSet: true}
}

func (v NullableResponseAgentsList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseAgentsList) UnmarshalJSON(src []byte) error {
	v.isSet = true

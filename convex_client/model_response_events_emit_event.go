...
// checks if the ResponseEventsEmitEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseEventsEmitEvent{}

// ResponseEventsEmitEvent struct for ResponseEventsEmitEvent
type ResponseEventsEmitEvent struct {
...
type _ResponseEventsEmitEvent ResponseEventsEmitEvent
...
func (o ResponseEventsEmitEvent) MarshalJSON() ([]byte, error) {
...
func (o ResponseEventsEmitEvent) ToMap() (map[string]interface{}, error) {
...
func (o *ResponseEventsEmitEvent) UnmarshalJSON(data []byte) (err error) {
	...
	varResponseEventsEmitEvent := _ResponseEventsEmitEvent{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResponseEventsEmitEvent)

	if err != nil {
		return err
	}

	*o = ResponseEventsEmitEvent(varResponseEventsEmitEvent)

	return err
}

type NullableResponseEventsEmitEvent struct {
	value *ResponseEventsEmitEvent
	isSet bool
}

func (v NullableResponseEventsEmitEvent) Get() *ResponseEventsEmitEvent {
	return v.value
}

func (v *NullableResponseEventsEmitEvent) Set(val *ResponseEventsEmitEvent) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseEventsEmitEvent) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseEventsEmitEvent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseEventsEmitEvent(val *ResponseEventsEmitEvent) *NullableResponseEventsEmitEvent {
	return &NullableResponseEventsEmitEvent{value: val, isSet: true}
}

func (v NullableResponseEventsEmitEvent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseEventsEmitEvent) UnmarshalJSON(src []byte) error {
	v.isSet = true

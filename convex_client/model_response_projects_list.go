...
// checks if the ResponseProjectsList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseProjectsList{}

// ResponseProjectsList struct for ResponseProjectsList
...
type _ResponseProjectsList ResponseProjectsList
...
func (o ResponseProjectsList) MarshalJSON() ([]byte, error) {
...
func (o ResponseProjectsList) ToMap() (map[string]interface{}, error) {
...
func (o *ResponseProjectsList) UnmarshalJSON(data []byte) (err error) {
	...
	varResponseProjectsList := _ResponseProjectsList{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResponseProjectsList)

	if err != nil {
		return err
	}

	*o = ResponseProjectsList(varResponseProjectsList)

	return err
}

type NullableResponseProjectsList struct {
	value *ResponseProjectsList
	isSet bool
}

func (v NullableResponseProjectsList) Get() *ResponseProjectsList {
	return v.value
}

func (v *NullableResponseProjectsList) Set(val *ResponseProjectsList) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseProjectsList) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseProjectsList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseProjectsList(val *ResponseProjectsList) *NullableResponseProjectsList {
	return &NullableResponseProjectsList{value: val, isSet: true}
}

func (v NullableResponseProjectsList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseProjectsList) UnmarshalJSON(src []byte) error {
	v.isSet = true

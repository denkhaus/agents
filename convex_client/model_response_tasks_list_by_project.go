...
// checks if the ResponseTasksListByProject type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseTasksListByProject{}

// ResponseTasksListByProject struct for ResponseTasksListByProject
type ResponseTasksListByProject struct {
...
type _ResponseTasksListByProject ResponseTasksListByProject
...
func NewResponseTasksListByProject(status string) *ResponseTasksListByProject {
	this := ResponseTasksListByProject{}
	this.Status = status
	return &this
}
...
func (o ResponseTasksListByProject) MarshalJSON() ([]byte, error) {
...
func (o ResponseTasksListByProject) ToMap() (map[string]interface{}, error) {
...
func (o *ResponseTasksListByProject) UnmarshalJSON(data []byte) (err error) {
	...
	varResponseTasksListByProject := _ResponseTasksListByProject{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResponseTasksListByProject)

	if err != nil {
		return err
	}

	*o = ResponseTasksListByProject(varResponseTasksListByProject)

	return err
}

type NullableResponseTasksListByProject struct {
	value *ResponseTasksListByProject
	isSet bool
}

func (v NullableResponseTasksListByProject) Get() *ResponseTasksListByProject {
	return v.value
}

func (v *NullableResponseTasksListByProject) Set(val *ResponseTasksListByProject) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseTasksListByProject) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseTasksListByProject) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseTasksListByProject(val *ResponseTasksListByProject) *NullableResponseTasksListByProject {
	return &NullableResponseTasksListByProject{value: val, isSet: true}
}

func (v NullableResponseTasksListByProject) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseTasksListByProject) UnmarshalJSON(src []byte) error {
	v.isSet = true

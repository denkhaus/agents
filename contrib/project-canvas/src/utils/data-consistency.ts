...
export function normalizeTaskData(rawTask: any): Task {
...
export function normalizeProjectData(rawProject: any): Project {
  const normalizedProject: Project = {
    ...
    createdAt: rawProject.createdAt ? new Date(rawProject.createdAt) : new Date(),
    updatedAt: rawProject.updatedAt ? new Date(rawProject.updatedAt) : new Date(),

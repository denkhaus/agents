          ...
          {part.functionCall && (
            <div className="mt-2 p-3 bg-blue-50 dark:bg-blue-950 border border-blue-200 dark:border-blue-800 rounded-lg">
              ...
              <details className="mt-2">
                ...
                <pre className="mt-2 text-xs overflow-x-auto bg-white dark:bg-gray-900 p-2 rounded border max-w-full w-fit">
          ...
          {part.functionResponse && (
            <div className="mt-2 p-3 bg-green-50 dark:bg-green-950 border border-green-200 dark:border-green-800 rounded-lg">
              ...
              <details className="mt-2">
                ...
                <pre className="mt-2 text-xs overflow-x-auto bg-white dark:bg-gray-900 p-2 rounded border max-h-40 max-w-full w-fit">

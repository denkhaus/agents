...
func (r *postgresRepository) AddTaskDependency(ctx context.Context, taskID uuid.UUID, dependsOnTaskID uuid.UUID) (*shared.Task, error) {
...
func (r *postgresRepository) RemoveTaskDependency(ctx context.Context, taskID uuid.UUID, dependsOnTaskID uuid.UUID) (*shared.Task, error) {
	var result *shared.Task
	err := r.withTx(ctx, func(ctx context.Context, tx *ent.Tx) error {
...
func (r *postgresRepository) GetTaskDependencies(ctx context.Context, taskID uuid.UUID) ([]*shared.Task, error) {
...
func (r *postgresRepository) GetDependentTasks(ctx context.Context, taskID uuid.UUID) ([]*shared.Task, error) {
...
func (r *postgresRepository) hasCircularDependencyInTx(ctx context.Context, tx *ent.Tx, fromTaskID, toTaskID uuid.UUID, visited map[uuid.UUID]bool) error {
...
func (r *postgresRepository) getTaskInTx(ctx context.Context, tx *ent.Tx, taskID uuid.UUID) (*shared.Task, error) {

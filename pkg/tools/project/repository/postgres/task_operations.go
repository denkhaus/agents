...
import (
	...
	taskpred "github.com/denkhaus/agents/pkg/tools/project/repository/postgres/ent/task"
...
func (r *postgresRepository) CreateTask(ctx context.Context, task *shared.Task) error {
...
func (r *postgresRepository) GetTask(ctx context.Context, id uuid.UUID) (*shared.Task, error) {
...
func (r *postgresRepository) UpdateTask(ctx context.Context, task *shared.Task) error {
	return r.withTx(ctx, func(ctx context.Context, tx *ent.Tx) error {
		...
		if task.State == shared.TaskStateCompleted && string(existingTask.State) != string(shared.TaskStateCompleted) {
			now := time.Now()
...
func (r *postgresRepository) getDescendantTaskIDsInTx(ctx context.Context, tx *ent.Tx, taskID uuid.UUID) ([]uuid.UUID, error) {

...
func (_c *TaskDependencyCreate) SetDependsOnTask(v *Task) *TaskDependencyCreate {
...
func (_c *TaskDependencyCreate) check() error {
	...
	if len(_c.mutation.DependsOnTaskIDs()) == 0 {
...
func (_c *TaskDependencyCreate) createSpec() (*TaskDependency, *sqlgraph.CreateSpec) {
	...
	if nodes := _c.mutation.DependsOnTaskIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: false,

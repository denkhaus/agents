...
func (f *cueToolFactoryImpl) createTool(toolName string, config tools.ConfigPayload) (tool.Tool, error) {
...
func (f *cueToolFactoryImpl) createToolSet(toolsetName string, config tools.ConfigPayload) (tool.ToolSet, error) {
